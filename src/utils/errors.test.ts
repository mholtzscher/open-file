...
describe('parseAwsError', () => {
  ...
  it('should extract region from error message', () => {
    const regionError = new Error(
      'Bucket in region: us-west-2, but client configured for us-east-1'
    );
...
describe('formatErrorForDisplay', () => {
  ...
  it('should wrap long error messages', () => {
    const error = new Error(
      'This is a very long error message that should be wrapped because it exceeds the maximum line length allowed'
    );
