...
const keybindings: HelpItem[] = [
  ...
  { section: '' },
  { section: 'OPERATIONS' },
  { keys: 'dd', description: 'Delete (with confirmation)' },
  { keys: 'yy', description: 'Copy to clipboard' },
  { keys: 'p', description: 'Paste from clipboard' },
  { keys: 'D', description: 'Download to local' },
  { keys: 'U', description: 'Upload from local' },
  { keys: 'r', description: 'Refresh listing' },
  { section: '' },
